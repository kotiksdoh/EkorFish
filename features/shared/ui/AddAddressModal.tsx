...
export const AddAddressModal: React.FC<AddAddressModalProps> = ({
    ...
    const isAddingAddress = useAppSelector((state) => state.catalog.isAddingAddress);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const result = await dispatch(addDeliveryAddress({
                companyId,
                addressData: payload
            }));
    ...
    return (
        ...
        >
            <ThemedView lightColor="#EBEDF0" darkColor="#040508" style={styles.modalContainer}>
                ...
                <ThemedView lightColor="#FFFFFF" darkColor="#151516" style={styles.content}>
                    <KeyboardAvoidingView
                                ...
                                <View style={styles.rowFields}>
                                    <View style={styles.halfWidthField}>
                                        <AnimatedTextInput
                                            ...
                                            onChangeText={(value) => setFormData(prev => ({ ...prev, apartment: value }))}
                                        />
                                    </View>
                                    <View style={styles.halfWidthField}>
                                        <AnimatedTextInput
                                            ...
                                            onChangeText={(value) => setFormData(prev => ({ ...prev, floor: value }))}
                                        />
                                    </View>
                                </View>
                                ...
                                <View style={styles.rowFields}>
                                    <View style={styles.halfWidthField}>
                                        <AnimatedTextInput
                                            ...
                                            onChangeText={(value) => setFormData(prev => ({ ...prev, entrance: value }))}
                                        />
                                    </View>
                                    <View style={styles.halfWidthField}>
                                        <AnimatedTextInput
                                            ...
                                            onChangeText={(value) => setFormData(prev => ({ ...prev, intercom: value }))}
                                        />
                                    </View>
                                </View>
